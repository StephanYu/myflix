...
describe Video do
  ...
  describe "#search_by_title" do
    ...
    it "returns an array of one video title if there is one video that is a full match" do
      fury = Video.create(title: "Fury", description: "a war movie")
    ...
    it "returns an array of one video title if there is one video that is a partial match" do
      fury = Video.create(title: "Fury", description: "a war movie")
